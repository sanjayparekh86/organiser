...
//                $("#items_list").listview("refresh");
    ...
    addContainer: function () {
        ...
        if (app.containers[app.counter].id != null) {
            app.containers[app.counter].element.css({width:app.containers[app.counter].width+"px",height:app.containers[app.counter].height+"px" ,top: app.containers[app.counter].top+"px", left: app.containers[app.counter].left+"px"})
        } else {
